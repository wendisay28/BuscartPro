            ...
            {artistCount > 0 ? (
              ...
              <Card>
                <CardContent className="p-12 text-center">
                  ...
                  <Button asChild>
                    <a href="/explorer">Explorar Artistas</a>
                  </Button>
                </CardContent>
              </Card>
            )}
            ...
            {favoriteArtists && favoriteArtists.length > 0 ? (
              ...
              <Card>
                <CardContent className="p-12 text-center">
                  ...
                  <Button asChild>
                    <a href="/explorer?type=artists">Explorar Artistas</a>
                  </Button>
                </CardContent>
              </Card>
            )}
            ...
            {favoriteEvents && favoriteEvents.length > 0 ? (
              ...
              <Card>
                <CardContent className="p-12 text-center">
                  ...
                  <Button asChild>
                    <a href="/explorer?type=events">Explorar Eventos</a>
                  </Button>
                </CardContent>
              </Card>
            )}
            ...
            {favoriteVenues && favoriteVenues.length > 0 ? (
              ...
              <Card>
                <CardContent className="p-12 text-center">
                  ...
                  <Button asChild>
                    <a href="/explorer?type=venues">Explorar Espacios</a>
                  </Button>
                </CardContent>
              </Card>
            )}
            ...
            {favoriteBlogPosts && favoriteBlogPosts.length > 0 ? (
              ...
              <Card>
                <CardContent className="p-12 text-center">
                  ...
                  <Button asChild>
                    <a href="/explorer?type=blog">Explorar Blog</a>
                  </Button>
                </CardContent>
              </Card>
            )}
