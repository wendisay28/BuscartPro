        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="artist">
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600">Configuración específica para artistas.</p>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="activity">
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600">Tu actividad en la plataforma.</p>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="settings">
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600">Configuración de privacidad y notificaciones.</p>
              </CardContent>
            </Card>
          </TabsContent>
        </Tabs>
